...
const Bollywood = () => {
    ...
    useEffect(()=>{
        const url = "https://reactblogbackend23.herokuapp.com/api/bollywood/";
  ...
  return (
    <>
    <div className='tit'><h1>----------BOLLYWOOD---------</h1></div>
    <div className='box4'>
    <div className='blog'>
        {
            data.map((res)=>{
        ...
        <div className='side'>
            ...
            <div><img src={"https://th.bing.com/th/id/OIP._9WXOes4d80ysQz90znniQHaJB?pid=ImgDet&rs=1"} width="300px" alt={""} height="200px"/></div>
        </div>
    </div>
